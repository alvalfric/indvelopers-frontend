    ...
    render() {
        return (
            <React.Fragment>
                ...
                <br />
                <br />
                <h1><strong>Terms and Conditions according to the GDPR legislation</strong></h1>
                <br />
                <p>
                ...
                <p>Welcome to inDvelopers!</p>

                <p>These terms and conditions outline the rules and regulations for the use of inDvelopers's Website, located at https://levelx-indvelopers.herokuapp.com/, where the x means the current version of the website.</p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use inDvelopers if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <ul>
                    ...
                    <li>Password: This will be used to log into your account. It is encrypted so that it stays safe, and it will not be shown to other users. Please remember that no administrator will ever ask you for your password, so do not give it to anyone else you do not trust completely.</li>
                </ul>

                <h3><strong>Cookies</strong></h3>

                <p>We employ the use of cookies. By accessing inDvelopers, you agreed to use cookies in agreement with the inDvelopers's Privacy Policy. </p>

                <p>Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>

                <h3><strong>License</strong></h3>

                <p>Unless otherwise stated, inDvelopers and/or its licensors own the intellectual property rights for all material on inDvelopers. All intellectual property rights are reserved. You may access this from inDvelopers for your own personal use subjected to restrictions set in these terms and conditions.</p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from inDvelopers</li>
                    <li>Sell, rent or sub-license material from inDvelopers</li>
                    <li>Reproduce, duplicate or copy material from inDvelopers</li>
                    <li>Redistribute content from inDvelopers</li>
                </ul>
                ...
                <p>You hereby grant inDvelopers a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
                ...
                <p>No use of inDvelopers's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
