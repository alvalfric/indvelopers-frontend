...
class HeaderComponent extends Component {
  ...
  <div className="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    //  <nav>
    //      <ul className="lista">
    //        <li className="elemento"><a className="linkElemento" href="#" ><img src={logo} width="200" height="50" /></a></li>
    ...
    //          <li className="elemento"><a className="linkElemento" href="#">Login</a></li>
    //      </ul>
    //  </nav>
        );
    }
