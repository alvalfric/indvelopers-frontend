    ...
    saveGame = (e) => {
        ...
        if (isValid) {
            ...
            let game = {
                ...
                , categorias: this.reformatedCategories, idCloud: this.state.idCloud, isNotMalware: false, creator: null, imagen: this.state.base64TextString, gallery: this.state.gallery
            };
